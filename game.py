...
class Snake:
    ...
    def draw(self, screen, size):
        pygame.draw.rect(screen, (255, 255, 255), [self.pos.x * size, self.pos.y * size, size-1, size-1])
...
class Game:
    ...
    def create_new_food(self):
        self.food = Vector2(random.randint(0, self.size-1), random.randint(0, self.size-1))
    ...
    def draw(self, screen: Surface):
        ...
        pygame.draw.rect(screen, (255, 255, 200), [self.food.x * sizeblock, self.food.y * sizeblock, sizeblock - 1, sizeblock - 1])